...
<div class="text-center">
	<div class="flex jusity-center items-center rounded-md m-2">
		...
		<img src="teamworkstock.png" alt="About Us" class="h-1/3 w-2/5" />
		<img src="whiteboardstock.png" alt="About Us" class="h-1/3 w-2/5" />
	</div>
	<div class="p-8">
		<div class="p-8 rounded-xl">
			<h2 class="mb-4 text-2xl font-bold text-slate-600">Our Mission</h2>
			<div class="rounded-xl p-8 text-slate-600">
				<p>
