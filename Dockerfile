...
# `/health` rather than `/`: it exercises the same process, routing, and listener without
# rendering the home page every 30 seconds, and it answers in a shape a client can parse.
